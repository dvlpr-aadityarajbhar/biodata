...
class Data {
  ...
  Data({this.id, this.fbId, this.gId, this.matriId, this.referenceId, this.prefix, this.title, this.isNri, this.description, this.keyword, this.terms, this.email, this.password, this.cpassword, this.cpassStatus, this.maritalStatus, this.profileby, this.timeToCall, this.reference, this.username, this.firstname, this.lastname, this.gender, this.birthdate, this.birthtime, this.birthplace, this.totalChildren, this.statusChildren, this.category, this.newEducationDetail, this.educationDetail, this.workingIn, this.income, this.occupation, this.employeeIn, this.designation, this.religion, this.caste, this.subcaste, this.gothra, this.gothraShowInBio, this.complexionShowInBio, this.star, this.moonsign, this.horoscope, this.manglik, this.motherTongue, this.height, this.weight, this.bloodGroup, this.complexion, this.bodytype, this.diet, this.smoke, this.drink, this.healthProblem, this.languagesKnown, this.address, this.countryId, this.stateId, this.city, this.nativeTaluka, this.phone, this.mobile, this.contactViewSecurity, this.residence, this.fatherName, this.motherName, this.fatherLivingStatus, this.motherLivingStatus, this.fatherOccupation, this.motherOccupation, this.profileText, this.lookingFor, this.familyDetails, this.familyType, this.familyStatus, this.fatherStatus, this.motherStatus, this.mamaSurname, this.surnameOfRelatives, this.familyValue, this.noOfBrothers, this.noOfSisters, this.noOfMarriedBrother, this.noOfMarriedSister, this.familyMobile, this.familyResidentAddress, this.familyNativePlace, this.fatherNameShowInBio, this.fatherOccupationShowInBio, this.motherNameShowInBio, this.motherOccupationShowInBio, this.familyMobileShowInBio, this.noOfBrothersShowInBio, this.noOfMarriedBrotherShowInBio, this.noOfSistersShowInBio, this.noOfMarriedSisterShowInBio, this.surnameOfRelativesShowInBio, this.familyResidentAddressShowInBio, this.familyNativePlaceShowInBio, this.mamaSurnameShowInBio, this.partFrmAge, this.partToAge, this.partBodytype, this.partDiet, this.partSmoke, this.partDrink, this.partIncome, this.partEmployeeIn, this.partOccupation, this.partDesignation, this.partExpect, this.partHeight, this.partHeightTo, this.partComplexion, this.partMotherTongue, this.partReligion, this.partCaste, this.partManglik, this.partStar, this.partEducation, this.partEducationNew, this.partCountryLiving, this.partState, this.partCity, this.partResiStatus, this.hobby, this.horoscopePhotoApprove, this.horoscopePhoto, this.photoProtect, this.photoPassword, this.video, this.videoApproval, this.videoUrl, this.videoViewStatus, this.photoViewStatus, this.photo1, this.photo1Approve, this.photo2, this.photo2Approve, this.photo3, this.photo3Approve, this.photo4, this.photo4Approve, this.photo5, this.photo5Approve, this.photo6, this.photo6Approve, this.photo7, this.photo7Approve, this.photo8, this.photo8Approve, this.photo1UploadedOn, this.photo2UploadedOn, this.photo3UploadedOn, this.photo4UploadedOn, this.photo5UploadedOn, this.photo6UploadedOn, this.photo7UploadedOn, this.photo8UploadedOn, this.registeredOn, this.ip, this.agent, this.agentApprove, this.lastLogin, this.status, this.fstatus, this.loggedIn, this.adminroleId, this.franchisedBy, this.staffAssignId, this.franchiseAssignId, this.staffAssignDate, this.franchiseAssignDate, this.commented, this.adminroleViewStatus, this.mobileVerifyStatus, this.planId, this.planName, this.planStatus, this.planExpiredOn, this.isDeleted, this.idProof, this.idProofApprove, this.idProofUploadedOn, this.horoscopePhotoUploadedOn, this.registeredFrom, this.coverPhoto, this.coverPhotoApprove, this.coverPhotoUploadedOn, this.cpasswordExpire, this.bioDataTitle, this.androidDeviceId, this.iosDeviceId, this.latitude, this.longitude, this.webDeviceId, this.educationDetailOther, this.employeeInOther, this.designationOther, this.occupationOther, this.visitYourProfileNotification, this.shortlistYourProfileNotification, this.remindNotification, this.chatMessageNotification, this.adminNotification, this.adminApproval, this.step, this.contact, this.property, this.expectations, this.educationLevel, this.updatedAt, this.createdAt, this.fromDate, this.toDate});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    familyResidentAddressShowInBio = json["family_resident_address_show_in_bio"];
    ...
    shortlistYourProfileNotification = json["shortlist_your_profile_notification"];
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["family_resident_address_show_in_bio"] = familyResidentAddressShowInBio;
    ...
    _data["shortlist_your_profile_notification"] = shortlistYourProfileNotification;
